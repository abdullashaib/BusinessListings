...
public class LocationPicker extends AppCompatActivity {
    ...
    TextView placeAPhoneNumberText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placeAPhoneNumberText = (TextView) findViewById(R.id.tvPlacePhonenumber);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST){
            if (resultCode == RESULT_OK){
                Place place = PlacePicker.getPlace(LocationPicker.this, data);
                placeNameText.setText(place.getName());
                placeAddressText.setText(place.getAddress());
                placeAPhoneNumberText.setText(place.getPhoneNumber());

                placeNameText.setVisibility(View.VISIBLE);
                placeAddressText.setVisibility(View.VISIBLE);
                placeAPhoneNumberText.setVisibility(View.VISIBLE);
